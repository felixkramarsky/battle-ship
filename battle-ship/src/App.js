...
class Game extends React.Component {
  ...
  handleClick(i, j) {
    ...
    let newHistory = [...this.state.history, { player1Board: this.state.player1Board, player2Board: this.state.player2Board, player1Turn: this.state.player1Turn }];
  ...
  undo() {
    ...
    this.setState({
      ...
      player1Turn: lastState.player1Turn,
    })
  }
